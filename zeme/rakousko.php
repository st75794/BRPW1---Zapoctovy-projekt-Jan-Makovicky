    ...
    <body>
        ...
        <main>
            <section class="destination-detail">
                <img src="../img/rakousko.jpg" class="destination-image">
                <h1 class="country-name">
                    Rakousko
                    <span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="4" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span>
                </h1>
